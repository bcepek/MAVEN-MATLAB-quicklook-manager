function [products_H, products_O, products_O2] = find_STA_mat_file_cleaned_Version2(date)
% find cleaned data

date = datestr(date, 'yyyymmdd');
root_STATIC = '\\193.232.6.100\общие\Владимир\MAVEN_data_in_MatLab_format_cleaned_Version2';
