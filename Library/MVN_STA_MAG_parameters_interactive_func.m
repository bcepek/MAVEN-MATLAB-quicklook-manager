% STATIC spectrograms and moments and MAG magnetic field vs time
% Uses oxygen spectrograms and moments cleaned from protons
% Last modified by Vladimir Ermakov at Augost 06, 2018

function MVN_STA_MAG_parameters_interactive_func(TimeStart, TimeEnd, windowpos)
...
windowpos(4) = floor(windowpos(4)*0.9);
...
cButton    = uicontrol('Style','popupmenu',...
    'String',{'Zoom on time axis (2)', 'Ion velocity MSO (0)', 'n-T diagram (2)', 'Box (4)','Energy Spectrum AVG 5 WINDOW (1)',...
    ...
    'O, O2 angle with surface (0)', 'Wavelet (0)'},...
    ...
    epoch_d1_disp, pos_sc_mso_d1_disp, quat_mso_d1_disp,...
