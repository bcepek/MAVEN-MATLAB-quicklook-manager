function xticks = plot_B_componentsand_magnitude_from_STA (plotNumber, bottomGap, plotHight, plotsGap, plotLeftGap, plotLength, FontSize, xticks, caxis_lims,...
...
a = plot(epoch_d1, Blx, 'r', 'LineWidth', LineWidth);
hold on 
b = plot(epoch_d1, Bly,  'LineWidth', LineWidth );
c = plot(epoch_d1, Blz,  'color', [0 0.498 0], 'LineWidth', LineWidth );
d = plot(epoch_d1, sqrt(Blx.^2 + Bly.^2 + Blz.^2),  'k', 'LineWidth', LineWidth);
