function xticks = plot_attenuator (plotNumber, bottomGap, plotHight, plotsGap, plotLeftGap, plotLength, FontSize, xticks,...
                                     epoch_d1,att_ind_d1, valid_d1, quality_flag_d1, sc_pot_d1 )
...
%*********************************************
plot(epoch_d1, att_ind_d1,'k','LineWidth',1.5);
grid on
hold on
