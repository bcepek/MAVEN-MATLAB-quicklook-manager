function filename_svyspec = find_swea_arcpad(cur_date) 
...
root = paths.swe_arcpad;
%root = '/Users/sesh2112/data/Matlab_MAVEN/SWEA/arcpad';
...
for i = 1:length(month_filelist)
    if(all(month_filelist(i).name(25:26) == cur_day))
